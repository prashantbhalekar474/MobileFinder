...
<html>
    ...
    <body>
        ...
        <section class="slider">
          <ul class="slides">
            <li>
              <img src="img/waterdrop1.jpg"> <!-- random image -->
            ...
            <li>
              ...
              <div class="caption right-align">
                <h3 class="bold white-text">Intelligent mobility starts here.</h3>
                <h5 class="bold white-text">Allowing your device to do more</h5>
              </div>
            </li>
          </ul>        
        </section>
